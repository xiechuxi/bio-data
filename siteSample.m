...
siteSample[siteProb_, backgroundProb_, siteFreqs_, backgroundFreqs_, numDraws_] := 
 Module[{i,j},
 Table[If[RandomVariate[BinomialDistribution[1,siteProb]]==1,
 Table[RandomVariate[EmpiricalDistribution[siteFreqs[[i]]->{1, 2, 3, 4}]],{i,1,Length[siteFreqs]}],
 RandomVariate[EmpiricalDistribution[backgroundFreqs->{1, 2, 3, 4}],Length[siteFreqs]]],{j,1,numDraws}]
